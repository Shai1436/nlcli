...
class TypoCorrector:
    ...
    def _load_typo_mappings(self):
        ...
        self.typo_mappings = {
            ...
            # Natural language mistakes - Common commands
            'show me files': 'ls',
            ...
            # Natural language - Process management
            'running processes': 'ps aux',
            'show processes': 'ps aux',
            'list processes': 'ps aux',
            'all processes': 'ps aux',
            'process list': 'ps aux',
            'what is running': 'ps aux',
            'task manager': 'top',
            'system monitor': 'top',
            ...
            # Natural language - Disk and memory
            'disk space': 'df -h',
            'storage space': 'df -h',
            'free space': 'df -h',
            'disk usage': 'df -h',
            ...
            'get package': 'npm install',
            'download package': 'npm install',
            'setup package': 'npm install',
            'install dependency': 'npm install',
            'update packages': 'npm update',
            'upgrade packages': 'npm update',
            'package update': 'npm update',
            'refresh packages': 'npm update',
            'install python package': 'pip install',
            'python install': 'pip install',
            'pip get': 'pip install',
            'python package': 'pip install',
            'update python packages': 'pip upgrade',
            'python update': 'pip upgrade',
            'system update': 'apt update',
            'update system': 'apt update',
            'refresh packages': 'apt update',
            'package update': 'apt update',
            'install program': 'apt install',
            'system install': 'apt install',
            'get program': 'apt install',
